...
contract StarNotary is ERC721 {
    ...
    constructor() public ERC721("CryptoStars", "STAR") {}
    ...
    {
        require(_exists(_tokenId), "There is no star with the provided Id");
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            _msgSender() == ownerOf(_tokenId1) ||
                _msgSender() == ownerOf(_tokenId2),
            "None of the stars owned by sender"
        );
        require(
            ownerOf(_tokenId1) != ownerOf(_tokenId2),
            "Tokens are owned by the same address"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(_msgSender() == ownerOf(_tokenId), "Star not owned by sender");
